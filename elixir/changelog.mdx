---
title: Changelog
description: Release history for BullMQ Elixir
---
...
<Card title="View Full Changelog" icon="github" href="https://github.com/taskforcesh/bullmq/blob/master/elixir/CHANGELOG.md">
